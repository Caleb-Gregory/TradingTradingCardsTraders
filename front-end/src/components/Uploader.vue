  ...
  <div class="modal-mask">
    <div class="modal-container">
      <form class="pure-form" @submit.prevent="upload">
        ...
        <fieldset>
          <input v-model="cardCost" placeholder="Card Cost">
        </fieldset>
        <fieldset>
          <input v-model="cardRarity" placeholder="Card Rarity">
        </fieldset>
        <fieldset>
          <textarea v-model="cardText" placeholder="Card Text"></textarea>
        </fieldset>
        <fieldset>
  ...
  methods: {
    ...
    async upload() {
      try {
        ...
        formData.append('card', this.file, this.file.name);
        formData.append('cardName', this.cardName);
        formData.append('cardCost', this.cardCost);
        formData.append('cardRarity', this.cardRarity);
        formData.append('cardText', this.cardText);
